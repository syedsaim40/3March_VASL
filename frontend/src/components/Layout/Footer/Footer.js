...
const Footer = () => {
  return (
    <footer id="footer">
      <Collapsible trigger="Get in Touch" className="accordian_footer hide_footer">
      ...
      <Collapsible trigger="Customer Care" className="accordian_footer hide_footer">
        <div className="mf_box">
      ...
      <Collapsible trigger="Information" className="accordian_footer hide_footer">
        <div className="mf_box">
          <ul className="unstyled services_list">
            <li>
              <Link to="/login">
