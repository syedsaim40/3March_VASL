  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      <TabPanel value={value} index={0}>
        ...
        <p>
          Enhance your wardrobe with this tranquil sage blue, A-line printed
          lawn kurti with a round neckline.
        </p>
        <span>Details:</span>
        <p>
          Printed front, Printed back, Full Sleeves, Round with slit Neckline
        </p>
        <span>Note:</span>{" "}
      ...
      <TabPanel value={value} index={2}>
        ...
        <p>
          ...
          department by emailing us at wecare@VASLonline.pk or you can call us
          at +92 (042) 111-738-245. Provide the required information to our
        ...
        <p>
          ...
          department by emailing us at wecare@sapphireonline.pk or you can call
          us at +92 (042) 111-738-245. Provide all the required information to
