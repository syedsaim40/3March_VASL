...
export const CHECK_ORDER_DETAILS_REQUEST = " CHECK_ORDER_DETAILS_REQUEST";
export const CHECK_ORDER_DETAILS_SUCCESS = "CHECK_ORDER_DETAILS_SUCCESS";
export const CHECK_ORDER_DETAILS_FAIL = "CHECK_ORDER_DETAILS_FAIL";
